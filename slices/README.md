...
| [iac-pipeline-restructure](iac-pipeline-restructure.md) | pending (diagnosis done) | iac-agent (the pipelines it restructures) | (fixes the provider→image→lock race + iac-image rebuild flood; merges IaCAgent into Ansible) |
