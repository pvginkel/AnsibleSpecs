...
- **[007](slices/007_argocd_tools_presync_hook/plan.md)** — ArgoCDTools and the PreSync hook image: the Terraform hook entrypoint, `registry:5000/argocd-hook:<n>`, and its OpenBao credentials (phases.md A.2; #124). **Planned** — eight phases.
